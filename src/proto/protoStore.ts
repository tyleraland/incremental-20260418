...
export const CLASS_CHANGE_QUESTS: ClassChangeQuestDef[] = [
  { id: 'path-fighter', locationId: 'prontera-city', targetClass: 'Fighter', title: 'Path of the Fighter', story: 'The Prontera guard drills recruits in sword and shield. Cull the wild boars in the meadow east of the city to prove your mettle.', objective: CULL('wild-boar', 3, 'Defeat 3 Wild Boars'), rewards: [{ kind: 'item', itemId: 'eq-sword' }] },
  ...
  { id: 'path-mage',    locationId: 'geffen-city',   targetClass: 'Mage',    title: 'Path of the Mage',    story: 'The arcane college admits only those who act. Scatter the forest sprites haunting the Overgrown Ruins.', objective: CULL('forest-sprite', 3, 'Scatter 3 Forest Sprites'), rewards: [{ kind: 'item', itemId: 'eq-staff' }] },
]
...
interface ProtoState {
  ...
  // in the real save envelope and advance through offline catch-up.
