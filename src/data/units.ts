...
export const INITIAL_UNITS: Unit[] = [
  ...
  },
  {
    ...
    abilityPoints: 25, skillPoints: 2, learnedSkills: { 'arcane-knowledge': 3, 'fire-bolt': 3, 'lightning-bolt': 2, 'heal': 3, 'firewall': 1, 'poison': 2, 'boost-agility': 2 },
    travelPath: null,
    ...
    actionSlots: bar('fire-bolt', 'lightning-bolt', 'heal', 'firewall', 'poison', 'boost-agility'),
  ...
  },
  {
    ...
    abilityPoints: 22, skillPoints: 3, learnedSkills: { 'keen-eyes': 5, 'arrow-shower': 2, 'ankle-snare': 1 },
    travelPath: null,
    weaponSets: [{ mainHand: 'eq-shortsword', offHand: null }, { mainHand: null, offHand: null }],
    activeWeaponSet: 0,
    equipment: { armor: 'eq-leather', sideboard1: null, sideboard2: null, accessory: null },
    actionSlots: bar('arrow-shower', 'ankle-snare'),
