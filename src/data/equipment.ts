...
export const INITIAL_EQUIPMENT: EquipmentItem[] = [
  ...
  { id: 'eq-knife-water',     name: 'Tide Knife',     category: 'weapon-1h', traits: ['1h', 'slashing', 'light', 'dagger'], stats: { attack: 12 }, slots: 0, description: 'A dagger of seawater and frost.',           element: 'water',     requiredLevel: 1, requiredClasses: KNIFE_CLASSES },
  ...
  { id: 'eq-knife-lightning', name: 'Spark Knife',    category: 'weapon-1h', traits: ['1h', 'slashing', 'light', 'dagger'], stats: { attack: 12 }, slots: 0, description: 'Crackling with current.',                    element: 'wind',      requiredLevel: 1, requiredClasses: KNIFE_CLASSES },
  ...
  { id: 'eq-knife-radiant',      name: 'Radiant Knife',     category: 'weapon-1h', traits: ['1h', 'slashing', 'light', 'dagger'], stats: { attack: 12 }, slots: 0, description: 'Radiant light pulses along the edge.',          element: 'radiant',      requiredLevel: 1, requiredClasses: KNIFE_CLASSES },
  ...
  { id: 'eq-rod',       name: 'Rod',   category: 'weapon-1h', traits: ['1h', 'bludgeoning', 'light', 'staff'], stats: { attack: 15, range: 5 }, slots: 3, description: 'A one-handed magical focus, swung in melee.',             requiredLevel: 1, requiredClasses: ['Novice', 'Cleric', 'Mage'] },
  ...
  { id: 'eq-wand',           name: 'Wand',           category: 'weapon-1h', traits: ['1h', 'light'],                     stats: { specialAttack: 4, range: 18 }, slots: 1, description: 'Channels magical energy.' },
