...
export const INITIAL_EQUIPMENT: EquipmentItem[] = [
  ...
  { id: 'eq-knife-lightning', name: 'Spark Knife',    category: 'weapon-1h', traits: ['1h', 'slashing', 'light', 'dagger'], stats: { attack: 12 }, slots: 0, description: 'Crackling with current.',                    element: 'lightning', requiredLevel: 1, requiredClasses: KNIFE_CLASSES },
  ...
  { id: 'eq-rod',       name: 'Rod',   category: 'weapon-1h', traits: ['1h', 'bludgeoning', 'light', 'staff'], stats: { attack: 15, range: 20 }, slots: 3, description: 'A one-handed magical focus staff.',             requiredLevel: 1, requiredClasses: ['Novice', 'Cleric', 'Mage'] },
