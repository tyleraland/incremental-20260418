...
export const INITIAL_EQUIPMENT: EquipmentItem[] = [
  ...
  { id: 'eq-knife-holy',      name: 'Holy Knife',     category: 'weapon-1h', traits: ['1h', 'slashing', 'light', 'dagger'], stats: { attack: 12 }, slots: 0, description: 'Holy light pulses along the edge.',          element: 'holy',      requiredLevel: 1, requiredClasses: KNIFE_CLASSES },
