...
export const INITIAL_EQUIPMENT: EquipmentItem[] = [
  ...
  { id: 'eq-wand',           name: 'Wand',           category: 'weapon-1h', traits: ['1h', 'light'],                     stats: { specialAttack: 4, range: 40 }, slots: 1, description: 'Channels magical energy.' },
  ...
  { id: 'eq-staff',          name: 'Staff',          category: 'weapon-2h', traits: ['2h', 'bludgeoning'],               stats: { specialAttack: 6, range: 40 }, slots: 2, description: 'Two-handed magical focus. Locks off-hand.' },
