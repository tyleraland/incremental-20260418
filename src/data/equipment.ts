...
export const INITIAL_EQUIPMENT: EquipmentItem[] = [
  ...
  { id: 'eq-knife-neutral',  name: 'Knife',          category: 'weapon-1h', traits: ['1h', 'slashing', 'light', 'dagger'], stats: { attack: 12 }, slots: 0, description: 'A plain dagger. Neutral damage.',           element: 'neutral',  requiredLevel: 1, requiredClasses: KNIFE_CLASSES },
  { id: 'eq-knife-water',    name: 'Tide Knife',     category: 'weapon-1h', traits: ['1h', 'slashing', 'light', 'dagger'], stats: { attack: 12 }, slots: 0, description: 'A dagger forged in seawater.',              element: 'water',    requiredLevel: 1, requiredClasses: KNIFE_CLASSES },
  { id: 'eq-knife-ice',      name: 'Frost Knife',    category: 'weapon-1h', traits: ['1h', 'slashing', 'light', 'dagger'], stats: { attack: 12 }, slots: 0, description: 'Frigid to the touch.',                       element: 'ice',      requiredLevel: 1, requiredClasses: KNIFE_CLASSES },
  { id: 'eq-knife-electric', name: 'Spark Knife',    category: 'weapon-1h', traits: ['1h', 'slashing', 'light', 'dagger'], stats: { attack: 12 }, slots: 0, description: 'Crackling with current.',                    element: 'electric', requiredLevel: 1, requiredClasses: KNIFE_CLASSES },
  { id: 'eq-knife-plant',    name: 'Thorn Knife',    category: 'weapon-1h', traits: ['1h', 'slashing', 'light', 'dagger'], stats: { attack: 12 }, slots: 0, description: 'A blade of hardened bramble.',               element: 'plant',    requiredLevel: 1, requiredClasses: KNIFE_CLASSES },
  { id: 'eq-knife-earth',    name: 'Stone Knife',    category: 'weapon-1h', traits: ['1h', 'slashing', 'light', 'dagger'], stats: { attack: 12 }, slots: 0, description: 'Chipped from heavy stone.',                  element: 'earth',    requiredLevel: 1, requiredClasses: KNIFE_CLASSES },
  { id: 'eq-knife-fire',     name: 'Ember Knife',    category: 'weapon-1h', traits: ['1h', 'slashing', 'light', 'dagger'], stats: { attack: 12 }, slots: 0, description: 'Glows with heat.',                           element: 'fire',     requiredLevel: 1, requiredClasses: KNIFE_CLASSES },
  { id: 'eq-knife-poison',   name: 'Venom Knife',    category: 'weapon-1h', traits: ['1h', 'slashing', 'light', 'dagger'], stats: { attack: 12 }, slots: 0, description: 'Coated in a clinging toxin.',                element: 'poison',   requiredLevel: 1, requiredClasses: KNIFE_CLASSES },
  { id: 'eq-knife-radiant',  name: 'Radiant Knife',  category: 'weapon-1h', traits: ['1h', 'slashing', 'light', 'dagger'], stats: { attack: 12 }, slots: 0, description: 'Holy light pulses along the edge.',          element: 'radiant',  requiredLevel: 1, requiredClasses: KNIFE_CLASSES },
  { id: 'eq-knife-shadow',   name: 'Shade Knife',    category: 'weapon-1h', traits: ['1h', 'slashing', 'light', 'dagger'], stats: { attack: 12 }, slots: 0, description: 'A blade that drinks the light.',             element: 'shadow',   requiredLevel: 1, requiredClasses: KNIFE_CLASSES },
  { id: 'eq-knife-ghost',    name: 'Phantom Knife',  category: 'weapon-1h', traits: ['1h', 'slashing', 'light', 'dagger'], stats: { attack: 12 }, slots: 0, description: 'Cuts through what should not be cut.',       element: 'ghost',    requiredLevel: 1, requiredClasses: KNIFE_CLASSES },
  { id: 'eq-knife-undead',   name: 'Bone Knife',     category: 'weapon-1h', traits: ['1h', 'slashing', 'light', 'dagger'], stats: { attack: 12 }, slots: 0, description: 'Carved from a thing that should rest.',      element: 'undead',   requiredLevel: 1, requiredClasses: KNIFE_CLASSES },
  // ── Starter weapons ──────────────────────────────────────────────────────────
