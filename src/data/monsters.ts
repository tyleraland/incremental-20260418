...
export const MONSTER_REGISTRY: Record<string, MonsterDef> = {
  ...
  'dragon-wyrmling': { id: 'dragon-wyrmling', name: 'Dragon Wyrmling', level: 5, health: 80, element: 'fire', size: 'medium', bodyShape: 'dragonWyrmling', attackName: 'Bite', stats: { attack: 15, defense: [5,4], magicAttack: 4, magicDefense: [3,4], attackSpeed: 12, accuracy: 13, dodge: 11, moveSpeed: 7, attackRange: 5 }, drops: [] },
