...
export type BodyShape = 'humanoid' | 'knight' | 'paperDoll' | 'blob' | 'beast' | 'flyer' | 'snail' | 'serpent' | 'canine' | 'fearrow' | 'crampRat' | 'mandragora' | 'spider' | 'mimic' | 'mimic2' | 'thiefBug' | 'larva' | 'centipede' | 'dragonWyrmling'
...
const MONSTER_SHAPE: Partial<Record<string, BodyShape>> = {
  ...
  'wolf': 'canine', 'dire-wolf': 'canine', 'shadow-wolf': 'canine', 'dragon-wyrmling': 'dragonWyrmling',
}
...
export const BODY_SHAPES = ['humanoid', 'knight', 'paperDoll', 'blob', 'beast', 'flyer', 'snail', 'serpent', 'canine', 'fearrow', 'crampRat', 'mandragora', 'spider', 'mimic', 'mimic2', 'thiefBug', 'larva', 'centipede', 'dragonWyrmling'] as const satisfies readonly BodyShape[]
