...
//   ?rigstyles=1 — horse/human/rhino style-bake comparison at 60° elevation.
...
const PaperRigStyleSheet = lazy(() => import('@/dev/PaperRigStyleSheet'))
...
const DEV_TOOL_PARAMS = ['gallery', 'workshop', 'mapgen', 'sandbox', 'monsterlab', 'riglab', 'rigperf', 'rigstyles', 'bodyshot'] as const
...
function App() {
  ...
  if (typeof window !== 'undefined' && devToolsEnabled()) {
    ...
    if (params.has('rigstyles')) return <DevPage><PaperRigStyleSheet /></DevPage>
