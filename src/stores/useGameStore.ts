...
export type RecipeSection = 'weapon' | 'armor' | 'other'

export interface CraftingRecipe {
  id: string; name: string; description: string; section: RecipeSection
...
export const RECIPE_REGISTRY: Record<string, CraftingRecipe> = {
  'recipe-plank':           { id: 'recipe-plank',           name: 'Wooden Plank',   description: 'Processed timber for construction.',            section: 'other',  ingredients: [{ itemId: 'm1', quantity: 2  }],                                outputItemId: 'craft-plank',          outputName: 'Wooden Plank',   outputQuantity: 3 },
  'recipe-iron-ingot':      { id: 'recipe-iron-ingot',      name: 'Iron Ingot',     description: 'Smelted iron bar ready for smithing.',           section: 'other',  ingredients: [{ itemId: 'm2', quantity: 3  }],                                outputItemId: 'craft-iron-ingot',     outputName: 'Iron Ingot',     outputQuantity: 1 },
  'recipe-fish-stew':       { id: 'recipe-fish-stew',       name: 'Fish Stew',      description: 'Hearty meal. Restores health in the field.',     section: 'other',  ingredients: [{ itemId: 'm3', quantity: 2  }, { itemId: 'm4', quantity: 1 }], outputItemId: 'craft-fish-stew',      outputName: 'Fish Stew',      outputQuantity: 2 },
  'recipe-herb-salve':      { id: 'recipe-herb-salve',      name: 'Herb Salve',     description: 'Soothing ointment for minor wounds.',           section: 'other',  ingredients: [{ itemId: 'm4', quantity: 3  }],                                outputItemId: 'craft-herb-salve',     outputName: 'Herb Salve',     outputQuantity: 1 },
  'recipe-preserved-fish':  { id: 'recipe-preserved-fish',  name: 'Preserved Fish', description: 'Salted fish that keeps for long journeys.',      section: 'other',  ingredients: [{ itemId: 'm3', quantity: 10 }],                                outputItemId: 'craft-preserved-fish', outputName: 'Preserved Fish', outputQuantity: 5 },
}
...
const UNITS: Unit[] = [
  { id: 'u1', name: 'Aldric',  level: 3, exp: 245, expToNext: 312, age: 24, health: 95,  class: 'Warrior', proficiencies: ['Swords', 'Heavy Armor'], locationId: null,           abilities: { strength: 8, agility: 5, dexterity: 4, constitution: 7, intelligence: 2 }, abilityPoints: 14, skillPoints: 1, learnedSkills: { 'sword-mastery-1h': 2 }, equipment: { mainHand: 'eq-sword-1h', offHand: 'eq-shield-wood', tool: null,         armor: 'eq-leather', accessory: null } },
  { id: 'u2', name: 'Mira',    level: 2, exp:  80, expToNext: 180, age: 19, health: 100, class: null,       proficiencies: ['Tools'],                  locationId: 'kings-forest', abilities: { strength: 4, agility: 5, dexterity: 6, constitution: 4, intelligence: 4 }, abilityPoints:  7, skillPoints: 1, learnedSkills: {},                                         equipment: { mainHand: null,           offHand: null,             tool: 'eq-handaxe', armor: null,         accessory: null } },
  { id: 'u3', name: 'Theron',  level: 4, exp: 420, expToNext: 520, age: 31, health: 82,  class: 'Mage',     proficiencies: ['Staves', 'Wands'],        locationId: 'gray-hills',   abilities: { strength: 3, agility: 5, dexterity: 6, constitution: 4, intelligence: 9 }, abilityPoints: 22, skillPoints: 2, learnedSkills: { 'arcane-knowledge': 3 },                  equipment: { mainHand: 'eq-staff',     offHand: null,             tool: null,         armor: null,         accessory: null } },
  ...
  { id: 'u5', name: 'Davan',   level: 2, exp: 120, expToNext: 180, age: 28, health: 67,  class: null,       proficiencies: ['Tools', 'Mining'],        locationId: null,           abilities: { strength: 6, agility: 4, dexterity: 5, constitution: 6, intelligence: 3 }, abilityPoints:  5, skillPoints: 1, learnedSkills: {},                                         equipment: { mainHand: null,           offHand: null,             tool: 'eq-pickaxe', armor: null,         accessory: null } },
  { id: 'u6', name: 'Lyra',    level: 5, exp: 750, expToNext: 800, age: 35, health: 90,  class: 'Rogue',    proficiencies: ['Daggers', 'Lockpicks'],   locationId: 'lake-arawok',  abilities: { strength: 6, agility: 9, dexterity: 8, constitution: 5, intelligence: 5 }, abilityPoints: 18, skillPoints: 3, learnedSkills: { 'keen-eyes': 5 },                         equipment: { mainHand: 'eq-shortsword',offHand: null,             tool: null,         armor: 'eq-leather', accessory: null } },
]
