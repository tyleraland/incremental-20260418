...
export interface CombatSetup {
  ...
  separationScale?: number  // scale the per-round overlap push (default 1); < 1 softens crowd shoves → smoother motion, tighter packing
...
export interface BattleState {
  ...
  separationScale: number                   // per-round overlap-push scale (default 1); < 1 = softer crowd shoves
