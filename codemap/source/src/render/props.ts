...
const PROP_META: Record<string, PropPlacement> = {
  ...
  reeds:    { kinds: ['reed', 'bush'], weight: 0.8, themes: ['water', 'beach'], role: 'edge', rotate: 'upright', near: ['water'], tags: ['wetland'], pass: 'walkable', footprint: 0.2, scaleJitter: [0.85, 1.15], anchor: ['water-edge'], orient: 'along' },
  ...
  bone:     { kinds: ['flower'], weight: 0.5, themes: ['dungeon', 'ruins', 'haunted'], role: 'field', rotate: 'free', pass: 'walkable', footprint: 0.15, sim: { lore: true } },
  ...
  skull:    { kinds: ['flower', 'rock'], weight: 0.3, themes: ['dungeon', 'ruins', 'haunted'], role: 'accent', rotate: 'upright', pass: 'walkable', footprint: 0.2, maxPerChunk: 1, sim: { lore: true } },
  ...
  cobweb:   { kinds: ['flower', 'bush'], weight: 0.4, themes: ['dungeon', 'ruins', 'haunted'], role: 'edge', rotate: 'flat', near: ['wall'], pass: 'walkable', footprint: 0.15, layer: 'wall', anchor: ['corner'] },
  // ── plaza biome (city market clutter fills the generic ground kinds) ──
  crate:    { kinds: ['stump'], weight: 1, themes: ['city'], role: 'field', rotate: 'upright', near: ['wall', 'path'], pass: 'solid', footprint: 0.35, gameplay: ['destructible'], sim: { statePair: 'cratedebris' } },
  ...
  pot:      { kinds: ['bush', 'flower'], weight: 0.7, themes: ['city'], role: 'field', rotate: 'upright', near: ['wall', 'path'], pass: 'solid', footprint: 0.25, gameplay: ['destructible'], sim: { statePair: 'potdebris' } },
  signpost: { kinds: ['tree'], weight: 0.4, themes: ['city'], role: 'accent', rotate: 'upright', near: ['path'], pass: 'solid', footprint: 0.25, tall: true, maxPerChunk: 1, gameplay: ['read'], anchor: ['path-edge'] },
  ...
  berrybush: { kinds: ['bush'], weight: 0.5, themes: ['forest', 'plains'], role: 'cluster', rotate: 'upright', clusterWith: ['bush', 'tuft'], pass: 'solid', footprint: 0.35, gameplay: ['harvestable'], sim: { resource: { respawn: 'slow' }, statePair: 'berrypicked' } },
  ...
  campring:  { kinds: ['rock', 'stump'], weight: 0.25, themes: ['forest', 'plains', 'mountain'], role: 'accent', rotate: 'free', near: ['path'], pass: 'solid', footprint: 0.3, themeWeight: { forest: 0.3, mountain: 0.3, plains: 0.15 }, light: { color: 'ember', radius: 2.5 }, maxPerChunk: 1, sim: { statePair: 'campcold' } },
  waysign:   { kinds: ['tree'], weight: 0.25, themes: ['forest', 'plains', 'mountain'], role: 'accent', rotate: 'upright', near: ['path'], pass: 'solid', footprint: 0.25, tall: true, themeWeight: { plains: 0.3, forest: 0.2, mountain: 0.2 }, maxPerChunk: 1, anchor: ['path-edge'] },
  // ── desert ──
  ...
  sunbones:   { kinds: ['flower', 'rock'], weight: 0.35, themes: ['desert'], role: 'field', rotate: 'free', pass: 'walkable', footprint: 0.2, sim: { lore: true } },
  ...
  obelisk:    { kinds: ['tree', 'stump'], weight: 0.2, themes: ['desert', 'ruins'], role: 'accent', rotate: 'upright', pass: 'solid', footprint: 0.45, tall: true, maxPerChunk: 1, sim: { lore: true } },
  ...
  fencerun:  { kinds: ['tree', 'stump'], weight: 0.5, themes: ['plains', 'village', 'farm'], role: 'edge', rotate: 'upright', near: ['path'], clusterWith: ['haybale'], pass: 'solid', footprint: 0.5, join: 'run' },
  ...
  waystone:  { kinds: ['rock'], weight: 0.25, themes: ['plains', 'mountain'], role: 'accent', rotate: 'upright', near: ['path'], pass: 'solid', footprint: 0.35, maxPerChunk: 1, anchor: ['path-edge'] },
  ...
  lilypad:       { kinds: ['reed'], weight: 0.6, themes: ['water', 'swamp'], role: 'field', rotate: 'free', near: ['water'], clusterWith: ['ripple'], layer: 'water-surface', pass: 'walkable', footprint: 0.2, anchor: ['water'] },
  steppingstone: { kinds: ['rock'], weight: 0.4, themes: ['water', 'beach'], role: 'edge', rotate: 'free', near: ['water', 'path'], pass: 'walkable', footprint: 0.25, anchor: ['water-edge'] },
  driftwood:     { kinds: ['stump'], weight: 0.5, themes: ['beach', 'water'], role: 'field', rotate: 'free', near: ['water'], pass: 'solid', footprint: 0.3, gameplay: ['flammable'], anchor: ['water-edge'], orient: 'along' },
  rowboat:       { kinds: ['stump'], weight: 0.15, themes: ['water', 'beach'], role: 'accent', rotate: 'upright', near: ['water'], pass: 'solid', footprint: 0.6, maxPerChunk: 1, anchor: ['water-edge'], orient: 'along' },
  fishnet:       { kinds: ['flower', 'bush'], weight: 0.25, themes: ['water', 'beach', 'city'], role: 'edge', rotate: 'flat', near: ['water'], pass: 'walkable', footprint: 0.2, gameplay: ['fish'], anchor: ['water-edge'] },
  ripple:        { kinds: ['reed'], weight: 0.8, themes: ['water'], role: 'field', rotate: 'flat', near: ['water'], clusterWith: ['lilypad'], layer: 'water-surface', anim: true, pass: 'walkable', footprint: 0.1, scaleJitter: [0.85, 1.15], anchor: ['water'] },
  mudbank:       { kinds: ['bush', 'flower'], weight: 0.5, themes: ['water', 'swamp'], role: 'field', rotate: 'flat', near: ['water'], pass: 'walkable', footprint: 0.2, themeWeight: { swamp: 0.55, water: 0.35 }, anchor: ['water-edge'], orient: 'along' },
  ...
  sunkenlog:  { kinds: ['stump'], weight: 0.5, themes: ['swamp', 'water'], role: 'field', rotate: 'free', near: ['water'], pass: 'solid', footprint: 0.35, themeWeight: { swamp: 0.55, water: 0.4 }, anchor: ['water-edge'], orient: 'along' },
  ...
  plankwalk:  { kinds: ['stump', 'rock'], weight: 0.4, themes: ['swamp'], role: 'edge', rotate: 'upright', near: ['path', 'water'], pass: 'walkable', footprint: 0.2, anchor: ['water-edge'], orient: 'along' },
  ...
  gravestone: { kinds: ['rock', 'stump'], weight: 0.12, themes: ['haunted', 'plains', 'forest'], role: 'accent', rotate: 'upright', pass: 'solid', footprint: 0.3, themeWeight: { haunted: 0.5, plains: 0.06, forest: 0.06 }, maxPerChunk: 2, sim: { lore: true } },
  ...
  // ── dungeon dressing ──
  brazier:    { kinds: ['tree', 'flower'], weight: 0.3, themes: ['dungeon', 'ruins'], role: 'accent', rotate: 'free', near: ['wall'], pass: 'solid', footprint: 0.3, light: { color: 'ember', radius: 3 }, maxPerChunk: 2, sim: { statePair: 'braziercold' } },
  ...
  urn:        { kinds: ['flower', 'bush'], weight: 0.6, themes: ['dungeon', 'ruins'], role: 'field', rotate: 'upright', near: ['wall'], clusterWith: ['cask'], pass: 'solid', footprint: 0.25, gameplay: ['destructible'], sim: { statePair: 'urnshards' } },
  ...
  bloodstain: { kinds: ['flower'], weight: 0.35, themes: ['dungeon', 'haunted'], role: 'field', rotate: 'flat', pass: 'walkable', footprint: 0.1, sim: { lore: true } },
  statue:     { kinds: ['tree', 'stump'], weight: 0.2, themes: ['dungeon', 'ruins', 'city'], role: 'accent', rotate: 'upright', pass: 'solid', footprint: 0.5, tall: true, themeWeight: { ruins: 0.25, dungeon: 0.2, city: 0.15 }, maxPerChunk: 1, sim: { lore: true } },
  ...
  chest:      { kinds: ['stump', 'rock'], weight: 0.15, themes: ['dungeon', 'ruins'], role: 'accent', rotate: 'upright', near: ['wall'], pass: 'solid', footprint: 0.3, gameplay: ['lootable'], maxPerChunk: 1, sim: { statePair: 'chestopen' } },
  spiketrap:  { kinds: ['rock', 'stump'], weight: 0.2, themes: ['dungeon'], role: 'field', rotate: 'flat', pass: 'walkable', footprint: 0.2, gameplay: ['trigger', 'damage'], tags: ['trap'], sim: { encounter: 'trigger' } },
  ...
  orevein:     { kinds: ['rock'], weight: 0.3, themes: ['mountain'], role: 'accent', rotate: 'free', near: ['wall', 'rock'], pass: 'solid', footprint: 0.35, gameplay: ['harvestable', 'mine'], maxPerChunk: 2, sim: { resource: { respawn: 'never' } } },
  ...
  doorshut:   { kinds: [], tags: ['interactable'], pass: 'solid', footprint: 0.5, anchor: ['entrance'], sim: { linkRole: 'gate', statePair: 'dooropen' } },
  dooropen:   { kinds: [], tags: ['interactable'], pass: 'walkable', footprint: 0.5 },
  lever:      { kinds: [], tags: ['interactable'], pass: 'solid', footprint: 0.2, sim: { linkRole: 'switch' } },
  floorplate: { kinds: [], tags: ['interactable'], pass: 'walkable', footprint: 0.3, sim: { linkRole: 'switch' } },
  ...
  coin:   { kinds: [], tags: ['pickup'], pass: 'walkable', footprint: 0.1, sim: { collect: true } },
  gem:    { kinds: [], tags: ['pickup'], pass: 'walkable', footprint: 0.1, sim: { collect: true } },
  potion: { kinds: [], tags: ['pickup'], pass: 'walkable', footprint: 0.1, sim: { collect: true } },
  key:    { kinds: [], tags: ['pickup'], pass: 'walkable', footprint: 0.1, sim: { collect: true, linkRole: 'key' } },
  // ── snow / tundra ──
  ...
  icefloe:       { kinds: ['rock', 'flower'], weight: 0.4, themes: ['snow', 'water'], role: 'field', rotate: 'free', near: ['water'], pass: 'walkable', footprint: 0.3, layer: 'water-surface', anchor: ['water'] },
  // ── volcanic ──
  ...
  // ── arcane ──
  runestone:    { kinds: ['rock', 'tree'], weight: 0.3, themes: ['arcane', 'ruins'], role: 'accent', rotate: 'upright', pass: 'solid', footprint: 0.4, tall: true, light: { color: 'bannerBlue', radius: 1.5 }, maxPerChunk: 3, sim: { mystery: true } },
  floatshard:   { kinds: ['rock', 'flower'], weight: 0.4, themes: ['arcane'], role: 'field', rotate: 'free', pass: 'walkable', footprint: 0.15, anim: true },
  manapool:     { kinds: ['flower', 'rock'], weight: 0.35, themes: ['arcane'], role: 'field', rotate: 'flat', pass: 'walkable', footprint: 0.35, light: { color: 'bannerBlue', radius: 2 }, sim: { mystery: true } },
  magiccircle:  { kinds: ['flower', 'rock'], weight: 0.25, themes: ['arcane', 'dungeon'], role: 'accent', rotate: 'flat', pass: 'walkable', footprint: 0.45, maxPerChunk: 1, sim: { mystery: true } },
  portalframe:  { kinds: ['tree', 'stump'], weight: 0.15, themes: ['arcane', 'ruins'], role: 'accent', rotate: 'upright', pass: 'solid', footprint: 0.55, tall: true, tags: ['portal'], maxPerChunk: 1, anim: true, sim: { mystery: true } },
  ...
  woodgate:     { kinds: ['tree', 'stump'], weight: 0.2, themes: ['plains', 'forest', 'city'], role: 'accent', rotate: 'upright', near: ['path'], clusterWith: ['fencerun'], pass: 'solid', footprint: 0.5, maxPerChunk: 2, tags: ['interactable'], anchor: ['entrance'], sim: { linkRole: 'gate', statePair: 'woodgateopen' } },
  ...
  portcullis:   { kinds: ['stump', 'tree'], weight: 0.2, themes: ['dungeon', 'ruins', 'city'], role: 'accent', rotate: 'upright', near: ['wall'], pass: 'solid', footprint: 0.55, maxPerChunk: 2, tags: ['interactable'], anchor: ['entrance'], sim: { linkRole: 'gate' } },
  brokengate:   { kinds: ['stump', 'rock'], weight: 0.25, themes: ['ruins', 'dungeon', 'haunted'], role: 'accent', rotate: 'upright', near: ['wall'], pass: 'walkable', footprint: 0.5, maxPerChunk: 2, anchor: ['entrance'] },
  cavemouth:    { kinds: ['rock', 'tree'], weight: 0.2, themes: ['mountain', 'cave', 'forest'], role: 'accent', rotate: 'upright', near: ['wall', 'rock'], pass: 'solid', footprint: 0.7, maxPerChunk: 1, tags: ['portal'], anchor: ['boundary'] },
  mineentrance: { kinds: ['stump', 'tree'], weight: 0.15, themes: ['mountain', 'cave'], role: 'accent', rotate: 'upright', near: ['wall'], clusterWith: ['minecart', 'beamframe'], pass: 'solid', footprint: 0.6, maxPerChunk: 1, tags: ['portal'], gameplay: ['descend'], anchor: ['boundary'] },
  ...
  beehive:       { kinds: ['flower', 'bush'], weight: 0.25, themes: ['forest', 'village', 'farm'], role: 'accent', rotate: 'upright', near: ['tree'], pass: 'walkable', footprint: 0.15, layer: 'canopy', maxPerChunk: 2, gameplay: ['destructible', 'harvestable'], sim: { resource: { respawn: 'slow' } } },
  toadstoolring: { kinds: ['flower', 'bush'], weight: 0.3, themes: ['forest', 'haunted', 'arcane'], role: 'understory', rotate: 'upright', pass: 'walkable', footprint: 0.4, maxPerChunk: 2, tags: ['ring', 'fae'], sim: { mystery: true } },
  quicksand:     { kinds: ['rock', 'flower'], weight: 0.3, themes: ['desert'], role: 'field', rotate: 'flat', pass: 'walkable', footprint: 0.4, maxPerChunk: 2 },
  digspot:       { kinds: ['flower', 'rock'], weight: 0.3, themes: ['desert', 'beach', 'plains', 'forest'], role: 'field', rotate: 'free', pass: 'walkable', footprint: 0.25, gameplay: ['lootable', 'dig'], sim: { statePair: 'digspot_dug' } },
  // ── shore & beach fills ──
  pier:       { kinds: ['stump'], weight: 0.2, themes: ['water', 'beach', 'city'], role: 'accent', rotate: 'upright', near: ['water'], clusterWith: ['rowboat', 'fishnet'], pass: 'walkable', footprint: 0.5, maxPerChunk: 1, anchor: ['water-edge'], orient: 'along' },
  buoy:       { kinds: ['reed'], weight: 0.3, themes: ['water'], role: 'field', rotate: 'free', pass: 'walkable', footprint: 0.12, layer: 'water-surface', anchor: ['water'] },
  algaemat:   { kinds: ['reed'], weight: 0.5, themes: ['water', 'swamp'], role: 'field', rotate: 'flat', pass: 'walkable', footprint: 0.25, layer: 'water-surface', scaleJitter: [0.85, 1.2], anchor: ['water'] },
  ...
  tidepool:   { kinds: ['rock', 'flower'], weight: 0.4, themes: ['beach'], role: 'field', rotate: 'free', pass: 'walkable', footprint: 0.3, anchor: ['water-edge'] },
  ...
  bench:       { kinds: ['stump'], weight: 0.4, themes: ['city', 'village'], role: 'field', rotate: 'upright', near: ['path', 'wall'], pass: 'solid', footprint: 0.35, gameplay: ['sit'], anchor: ['path-edge'] },
  awning:      { kinds: ['flower', 'bush'], weight: 0.3, themes: ['city'], role: 'edge', rotate: 'upright', near: ['wall'], pass: 'walkable', footprint: 0.2, layer: 'wall', anchor: ['wall'], orient: 'face-open' },
  ...
  sarcophagus: { kinds: ['stump', 'rock'], weight: 0.2, themes: ['dungeon', 'ruins', 'haunted'], role: 'accent', rotate: 'upright', pass: 'solid', footprint: 0.55, maxPerChunk: 2, gameplay: ['lootable'], sim: { statePair: 'sarcoph_open', lore: true } },
  ...
  hoard:       { kinds: ['rock', 'flower'], weight: 0.15, themes: ['dungeon', 'ruins'], role: 'accent', rotate: 'free', pass: 'walkable', footprint: 0.35, maxPerChunk: 1, gameplay: ['lootable'], light: { color: 'bannerGold', radius: 1 }, sim: { statePair: 'hoard_looted' } },
  floorrunes:  { kinds: ['flower'], weight: 0.3, themes: ['dungeon', 'arcane', 'ruins'], role: 'field', rotate: 'flat', pass: 'walkable', footprint: 0.3, sim: { mystery: true } },
  // ── state pairs II ──
  ...
  lamppost: { kinds: [], anchor: ['path-edge'], series: { along: 'path', spacing: [4, 7] } },
  banner:   { kinds: [], anchor: ['wall'], orient: 'face-open' },
}
